...
function FAQ() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Так, звичайно! Ми покажемо вам як керувати сайтом, передамо доступ відповідальній особі або декільком. Система керування проста та зручна. Підтримка повністю безкоштовна, 24/7, 365 днів.'
    },
    {
