          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12">
            <div className="prose prose-lg max-w-none">
              <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                Vertex - це сучасна діджитал агенція, яка спеціалізується на створенні 
              ...
              <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                Vertex активно використовує штучний інтелект та передові технології для досягнення 
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                Оберіть якість та надійність – оберіть розробку сайта під ключ від Vertex.
              </p>
            </div>
          </div>
        </div>
