...
function About() {
  ...
  const scrollingText = "• Vertex - Діджитал Агенція  •  Створення Сайтів  •  Веб-Дизайн  •  Розробка сайтів  •  Підтримка  •  Швидко  •  Якісно  •  Надійно  •  Інновації  •       Результат  •      Бізнес Рішення  •  Розвиток";
